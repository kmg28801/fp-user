package tjjh.foodplatform.user.service.impl;
...
import tjjh.foodplatform.user.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto getUserDetailsByEmail(String email) {
        ...
        UserDto userDto = new ModelMapper().map(this.userRepository.findByEmail(email), UserDto.class);
        return userDto;
    }
